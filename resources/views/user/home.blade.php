...
@section('mainContent')
        <div class="container-fluid text-center mt-4">
          <div class="row mx-auto">
            ...
            @if(isset($materialUser) && !count($materialUser) == 0)
            ...
            @endforeach
            @else
            <h1>Anda belum bergabung ke kelas mana pun</h1>
            <h2>Silahkan bergabung ke Kelas</h2>
            <a href="{{route('all.materi')}}" class="btn btn-gabung mx-auto">Gabung Kelas</a>
            @endif
